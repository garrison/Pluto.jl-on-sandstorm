...
const pkgdef :Spk.PackageDefinition = (
  ...
  manifest = (
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "computational notebook"),
        command = .myCommand
    ...
    metadata = (
      ...
      icons = (
        ...
        grain = (svg = embed "favicon.svg"),
        #market = (svg = embed "path/to/market-150x150.svg"),
        #marketBig = (svg = embed "path/to/market-big-300x300.svg"),
      ),

      website = "https://plutojl.org/",
      # This should be the app's main website url.

      codeUrl = "https://github.com/fonsp/Pluto.jl",
      ...
      author = (
        ...
        contactEmail = "pluto@jr.garrison.cc",
        ...
        upstreamAuthor = "Fons van der Plas",
      ...
      description = (defaultText = embed "description.markdown"),
      # The app's description in Github-flavored Markdown format, to be displayed e.g.
      # in an app store. Note that the Markdown is not permitted to contain HTML nor image tags (but
      # you can include a list of screenshots separately).

      shortDescription = (defaultText = "Reactive notebook"),
      ...
      changeLog = (defaultText = embed "changelog.markdown"),
  ...
  # https://github.com/sandstorm-io/sandstorm/issues/1582#issuecomment-188922691
  # following also https://github.com/zenhack/dotnet-docker-spk/blob/master/sandstorm-pkgdef.capnp
  # and https://github.com/sandstorm-io/sandstorm-rawapi-example/blob/a5953cafba24bf7ec7b8ece610ca51b63446f0d3/sandstorm-pkgdef.capnp#L59-L61
  sourceMap = (
    searchPath = [
